  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        ground: 'border-transparent bg-amber-900 text-white',
        electric: 'border-transparent bg-amber-300 text-white',
        flying: 'border-transparent bg-sky-200 text-black',
        bug: 'border-transparent bg-green-900 text-white',
